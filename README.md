...
![Hosted Image](https://upload.wikimedia.org/wikipedia/commons/8/88/Wausan-ro_21-gil_Hongdae.JPG "Hongdae Street")

## Displaying Local Images

You can also upload an image into your repo. 

![Tteokbokki](https://github.com/coltonsteeve/working-with-markdown/blob/master/Tteokbokki.JPG "Example local image")
